...
import { mockExpenses, mockRevenueData, expenseCategories } from '../../data/mockData';
...
const ExpenseReport = () => {
  ...
  return (
    <Layout title="Expense Report" subtitle="Detailed expense analysis and profit overview">
      {/* Filters */}
      ...
      <div className="card mt-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-dark-800">Recent Expenses</h3>
          <a href="/expenses" className="text-primary-600 text-sm font-medium">
            View All →
          </a>
        </div>
